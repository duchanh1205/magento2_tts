...
namespace Tigren\DeliveryDate\Plugin\Checkout\Block;
...
{
    /**
     * @var \Tigren\DeliveryDate\Model\Config
     */
    protected $config;
    ...
    public function afterProcess(
        ...
        ['shippingAddress']['children']['shippingAdditional'] = [
            ...
            'children' => [
                'delivery_date' => [
                    'component' => 'Tigren_DeliveryDate/js/view/delivery-date-block',
                    ...
                    'children' => [
                        'form-fields' => [
                            ...
                            'children' => [
                                'delivery_date' => [
                                    'component' => 'Tigren_DeliveryDate/js/view/delivery-date',
                                    'config' => [
                                        'customScope' => 'delivery_date',
                                        'template' => 'ui/form/field',
                                        'elementTmpl' => 'Tigren_DeliveryDate/fields/delivery-date',
                                        'options' => [],
                                        'id' => 'delivery_date',
