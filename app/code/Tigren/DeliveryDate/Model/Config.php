...
class Config
{
    const XPATH_FORMAT = 'tigren_deliverydate/general/format';
    const XPATH_DISABLED = 'tigren_deliverydate/general/disabled';
    const XPATH_HOURMIN = 'tigren_deliverydate/general/hourMin';
    const XPATH_HOURMAX = 'tigren_deliverydate/general/hourMax';
    const XPATH_REQUIRED_DELIVERY_DATE = 'tigren_deliverydate/general/required_delivery_date';
    ...
    {
        $store = $this->getStoreId();
        return (bool)$this->scopeConfig->getValue(self::XPATH_REQUIRED_DELIVERY_DATE, ScopeInterface::SCOPE_STORE,
            $store);
    }
